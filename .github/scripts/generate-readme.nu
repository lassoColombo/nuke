...
let res = open doc/resources/resources.yaml
| where {'get' in ($in.verbs? | default [])}

let formatters = mod show supported-formatters
let unwilling_to_support = open doc/resources/unwilling_to_support.yaml
...
let coverage = open -r doc/templates/readme/resource-coverage.mmd
...
open -r doc/templates/readme/readme.md 
